...
##### 3.连接远程仓库
		...
		3）git clone git@github.com:peichangqiang/repository-name 从远程把建立的仓库克隆下来。
...
###### 	1）shift + /
	...
	该操作可以查看到github快捷键一览表

![1534689918336](C:\Users\ADMINI~1\AppData\Local\Temp\1534689918336.png)

##### 2.仓库面板功能介绍

	首先仓库页面如图:

![1534691473553](C:\Users\ADMINI~1\AppData\Local\Temp\1534691473553.png)

| ui显示                   | 介绍说明                                                     |
| ------------------------ | ------------------------------------------------------------ |
| PeiChangqiang/StudySpace | 这是仓库的名称                                               |
| Watch/Star/Fork          | Watch后该仓库的更新信息显示在用户的活动中。Star是给该仓库添加星，越多说明越热门。Fork的次数代表被拉到各用户仓库的次数。说明参与这个项目系统开发的人数。 |
| Code                     | 该仓库的文件列表                                             |
| Issues                   | Bug报告，功能添加，方向性讨论等。Pull Requests会创建Issue。数字表示当前open的issue数。 |
| Pull requests            | 代码的更改和讨论，数字是尚未close的pull request。            |
| Wiki                     | 简单的页面描述功能。用于记录共享的信息文档。                 |
| Settings                 | 更改当前仓库的设置。有这个权限的才能看到这个菜单。           |
|                          |                                                              |
